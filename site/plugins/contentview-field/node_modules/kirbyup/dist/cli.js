...
var multilineCommentsRE, singlelineCommentsRE;
    ...
    async transform(code, id) {
      if (code.includes("kirbyup.import")) {
        ...
        while (match = kirbyupImportRE.exec(noCommentsCode)) {
          ...
          if (!s)
            s = new import_magic_string.default(code);
...
var init_autoImport = __esm({
  "src/plugins/autoImport.ts"() {
    init_cjs_shims();
    import_magic_string = __toModule(require_magic_string_cjs());
    init_utils();
  }
});
...
async function runViteBuild(options) {
  ...
  try {
    result = await (0, import_vite.build)({
      mode,
      plugins: [(0, import_vite_plugin_vue2.createVuePlugin)(), kirbyupAutoImportPlugin()],
      build: {
        lib: {
